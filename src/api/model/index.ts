...
export interface ICar {
    ...
    views: number;
    dealerId: number | any;
    has_logo: boolean | any;
    logo_ver: any;
    active_ads: any;
    dealer_title: string | any;
    has_predicted_price: boolean;
    pred_first_breakpoint: number | undefined;
    pred_second_breakpoint: number | undefined;
    pred_min_price: number | undefined;
    pred_max_price: number | undefined;
    comfort_features: Array<number>;
}